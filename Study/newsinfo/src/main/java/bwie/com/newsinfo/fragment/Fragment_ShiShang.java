...
public class Fragment_ShiShang extends Fragment implements XListView.IXListViewListener, AdapterView.OnItemClickListener {
    ...
    public void getData() {
        ...
        try {
            getJson("http://v.juhe.cn/toutiao/index?type=shishang&key=54e3d5f4ee64f51bef570ce8505d37b5");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
        ...
        new AsyncTask<String, Void, String>() {
            ...
            protected void onPostExecute(String s) {
                ...
                if(s == null){
                    ...
                    List<HttpData.ResultBean.DataBean> dataList = json.getResult().getData();
                    if(dataAdapter == null){
