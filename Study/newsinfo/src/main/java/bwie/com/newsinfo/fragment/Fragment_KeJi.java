...
public class Fragment_KeJi extends Fragment implements XListView.IXListViewListener, AdapterView.OnItemClickListener {
    ...
    public void getData() {
        ...
        try {
            getJson("http://v.juhe.cn/toutiao/index?type=keji&key=54e3d5f4ee64f51bef570ce8505d37b5");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
